                            ...
                            <tbody>
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="edit-leave.php?levid=<?php echo htmlentities($result->id); ?>" class="btn btn-success btn-sm">Edit</a>
                                            <a href="manage-leave.php?del=<?php echo htmlentities($result->id); ?>" 
