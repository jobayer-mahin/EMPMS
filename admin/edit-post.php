...
$category = $_POST['category'];$titlename = $_POST['titlename'];$package = $_POST['package'];$packageduratiobn = $_POST['packageduratiobn'];$Price = $_POST['Price'];$photo = $_POST['photo'];$description = $_POST['description'];
        ...
        <div class="col-md-12">
          ...
          <?php } ?>
            <h3 class="tile-title">Update Post</h3>
               <?php
                   include  'include/config.php';
                  $sql="SELECT * FROM gim.tbladdpackage as t1
